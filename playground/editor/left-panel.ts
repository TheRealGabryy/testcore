...
import { showDonateModal } from '../donate-modal';
...
export function setupLeftPanel(el: HTMLElement, state: EditorState, onLoadDemo?: () => void) {
  el.innerHTML = `
    <div class="assets-header">
      ...
      <div class="assets-header-actions">
        ...
        <button class="assets-demo-btn" id="assets-demo-btn" title="Load FlashFX demo composition">
          ${svgIcon('<polygon points="5 3 19 12 5 21 5 3"/>')}
          Demo
        </button>
        <button class="assets-support-btn" id="assets-support-btn" title="Support this project">
  ...
  const supportBtn = el.querySelector('#assets-support-btn') as HTMLButtonElement;
  ...
  supportBtn.addEventListener('click', showDonateModal);
